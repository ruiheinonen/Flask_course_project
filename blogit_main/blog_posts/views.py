...
from blogit_main.blog_posts.forms import BlogPostForm
...
def update(blog_post_id):
    ...
    # Make sure when ppl first view the update page the original title and text 
    # are already prefilled in the form 
